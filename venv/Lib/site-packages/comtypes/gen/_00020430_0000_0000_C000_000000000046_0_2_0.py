...
__all__ = [ 'StdPicture', 'FONTUNDERSCORE', 'IPicture', 'Checked',
           'FONTSTRIKETHROUGH', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_PIXELS', 'Color', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC', 'IPictureDisp',
           'OLE_CANCELBOOL', 'Gray', 'FONTITALIC', 'OLE_XPOS_PIXELS',
           'OLE_YPOS_PIXELS', 'VgaColor', 'OLE_HANDLE',
           'OLE_TRISTATE', 'OLE_COLOR', 'OLE_YPOS_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'Default', 'Monochrome', 'Font',
           'IFontDisp', 'StdFont', 'Picture', 'FONTBOLD', 'IFont',
           'OLE_YSIZE_PIXELS', 'OLE_YSIZE_CONTAINER', 'FONTSIZE',
           'OLE_XPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'LoadPictureConstants', 'Unchecked', 'FontEvents',
